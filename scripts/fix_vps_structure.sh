...
sudo chown -R reunionwiki:www-data "$APP_DIR"/{tmp,logs,data}
echo "✓ Dossiers tmp, logs et data créés"
...
echo "- $APP_DIR/scripts/restart_app.sh"
echo "- $APP_DIR/scripts/diagnostic.sh"
echo ""
