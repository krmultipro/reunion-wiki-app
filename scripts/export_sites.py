...
DEFAULT_EXPORT_DIR = BASE_DIR / "data" / "backups" / "exports"
...
def parse_args() -> argparse.Namespace:
    ...
    default_db = os.getenv("DATABASE_PATH", str(DEFAULT_DB_PATH))
    default_output = os.getenv("EXPORT_OUTPUT_DIR", str(DEFAULT_EXPORT_DIR))
